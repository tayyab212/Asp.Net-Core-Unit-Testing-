...
namespace web_api_tests
{
    public class ShoppingCartControllerTest
    {
        ...
        [Fact]
        public void TestTayyab_ZeroPassed_ReturnNotFoundResponse()
        {
            // Arrange
            var id = 0;

            // Act
            var okResponse = _controller.TestTayyab(id);

            // Assert
            Assert.IsType<NotFoundResult>(okResponse);
        } 
        
        [Fact]
        public void TestTayyab_OnePassed_ReturnFoundResponse()
        {
            // Arrange
            var id = 1;
